"""
Django settings for oharaproject project.
...
SECRET_KEY = 'django-insecure-)#%+trbdt+nhrzgs%9ga+4ea8r3v=%f19^@a5_^hi2q%vwivgv'
...
ROOT_URLCONF = 'oharaproject.urls'
